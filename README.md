...
**多谢给我点小星星的铁子们，为对得起你的支持，我完完整整重写了所有页面，也填坑了第二版**
- 初版的fish_redux的玩Android是我刚学flutter时写的，代码写的比较混乱，此处重构的代码，
也是为了让大家更清晰了解fish_redux结构，也给出TabBar在fish_redux初始化的解决方案，大家可以看看
