...
projectDetailBeanFromJson(ProjectDetailBean data, Map<String, dynamic> json) {
	if (json['data'] != null) {
...
Map<String, dynamic> projectDetailBeanToJson(ProjectDetailBean entity) {
...
projectDetailDataFromJson(ProjectDetailData data, Map<String, dynamic> json) {
	...
	if (json['datas'] != null) {
		data.datas = new List<ProjectDetailDataData>();
		(json['datas'] as List).forEach((v) {
			data.datas.add(new ProjectDetailDataData().fromJson(v));
		});
	}
	if (json['offset'] != null) {
...
projectDetailDataDataFromJson(ProjectDetailDataData data, Map<String, dynamic> json) {
	...
	if (json['tags'] != null) {
		data.tags = new List<ProjectDetailDataDatasTag>();
		(json['tags'] as List).forEach((v) {
			data.tags.add(new ProjectDetailDataDatasTag().fromJson(v));
		});
	}
	if (json['title'] != null) {
...
Map<String, dynamic> projectDetailDataDataToJson(ProjectDetailDataData entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
...
projectDetailDataDatasTagFromJson(ProjectDetailDataDatasTag data, Map<String, dynamic> json) {
	if (json['name'] != null) {
...
Map<String, dynamic> projectDetailDataDatasTagToJson(ProjectDetailDataDatasTag entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
