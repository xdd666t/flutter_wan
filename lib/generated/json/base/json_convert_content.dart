...
class JsonConvert<T> {
    ...
    switch (type) {			case HomeArticleBean:
			...
			return homeArticleDataDataFromJson(data as HomeArticleDataData, json) as T;			case BannerBean:
    ...
    return data as T;
		...
		switch (type) {			case HomeArticleBean:
			...
			return homeArticleDataDataToJson(data as HomeArticleDataData);			case BannerBean:
    ...
    switch (T.toString()) {			case 'HomeArticleBean':
			return HomeArticleBean().fromJson(json) as T;			case 'HomeArticleData':
			return HomeArticleData().fromJson(json) as T;			case 'HomeArticleDataData':
			return HomeArticleDataData().fromJson(json) as T;			case 'BannerBean':
			return BannerBean().fromJson(json) as T;			case 'BannerData':
