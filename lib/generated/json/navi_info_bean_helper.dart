...
naviInfoBeanFromJson(NaviInfoBean data, Map<String, dynamic> json) {
	if (json['data'] != null) {
		data.data = new List<NaviInfoData>();
		(json['data'] as List).forEach((v) {
			data.data.add(new NaviInfoData().fromJson(v));
		});
	}
...
Map<String, dynamic> naviInfoBeanToJson(NaviInfoBean entity) {
...
naviInfoDataFromJson(NaviInfoData data, Map<String, dynamic> json) {
	if (json['articles'] != null) {
		data.articles = new List<NaviInfoDataArticle>();
		(json['articles'] as List).forEach((v) {
			data.articles.add(new NaviInfoDataArticle().fromJson(v));
		});
	}
	if (json['cid'] != null) {
...
Map<String, dynamic> naviInfoDataToJson(NaviInfoData entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
...
naviInfoDataArticleFromJson(NaviInfoDataArticle data, Map<String, dynamic> json) {
...
Map<String, dynamic> naviInfoDataArticleToJson(NaviInfoDataArticle entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
