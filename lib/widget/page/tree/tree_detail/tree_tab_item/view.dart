...
Widget buildView(
    TreeTabItemState state, Dispatch dispatch, ViewService viewService) {
...
Widget _itemWidget(TreeTabItemState state, Dispatch dispatch) {
  return Card(
    ...
    shape:
        RoundedRectangleBorder(borderRadius: BorderRadius.circular(auto(20))),
    child: InkWell(
      //点击效果
      borderRadius: BorderRadius.circular(auto(20)),
      child: _itemContentWidget(state),
      onTap: () => dispatch(
          TreeTabItemActionCreator.openArticleContent(state.itemDetail)),
    ),
  );
}
  ...
  return Column(
    children: <Widget>[
      ...
      Container(
        ...
        child: Row(
          children: <Widget>[
            ...
            Text('分类: '),
            Text(
              '${state.itemDetail.superChapterName}/${state.itemDetail.chapterName}',
      ...
      Container(
        ...
        child:
            Text(state.itemDetail.title, style: TextStyle(fontSize: setSp(32))),
      ),
      //第三层: 标题底下时间,作者
      Container(
        ...
        child: Stack(
          children: <Widget>[
            Container(
              child: Text(
                  '作者: ${state.itemDetail.author == "" ? "未知" : state.itemDetail.author}'),
            ),
            Container(
              ...
              child: Row(
                ...
                children: <Widget>[
                  Text('时间: '),
                  Text(state.itemDetail.niceShareDate),
                ],
              ),
            )
          ],
