...
projectBeanFromJson(ProjectBean data, Map<String, dynamic> json) {
	if (json['data'] != null) {
		data.data = new List<ProjectData>();
		(json['data'] as List).forEach((v) {
			data.data.add(new ProjectData().fromJson(v));
		});
	}
...
Map<String, dynamic> projectBeanToJson(ProjectBean entity) {
...
projectDataFromJson(ProjectData data, Map<String, dynamic> json) {
...
Map<String, dynamic> projectDataToJson(ProjectData entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
