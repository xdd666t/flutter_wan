...
part 'project_detail_bean.g.dart';

@JsonSerializable()
class ProjectDetailBean extends Object {
  @JsonKey(name: 'data')
  Data data;
  ...
  factory ProjectDetailBean.fromJson(Map<String, dynamic> srcJson) =>
      _$ProjectDetailBeanFromJson(srcJson);

  Map<String, dynamic> toJson() => _$ProjectDetailBeanToJson(this);
}
