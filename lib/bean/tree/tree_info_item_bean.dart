...
part 'tree_info_item_bean.g.dart';


@JsonSerializable()
  class TreeInfoItemBean extends Object {
  ...
  TreeInfoItemBean(this.data,this.errorCode,this.errorMsg,);

  factory TreeInfoItemBean.fromJson(Map<String, dynamic> srcJson) => _$TreeInfoItemBeanFromJson(srcJson);

  Map<String, dynamic> toJson() => _$TreeInfoItemBeanToJson(this);
