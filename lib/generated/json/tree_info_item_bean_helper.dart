...
treeInfoItemBeanFromJson(TreeInfoItemBean data, Map<String, dynamic> json) {
	if (json['data'] != null) {
		data.data = new TreeInfoItemData().fromJson(json['data']);
	}
...
Map<String, dynamic> treeInfoItemBeanToJson(TreeInfoItemBean entity) {
...
treeInfoItemDataFromJson(TreeInfoItemData data, Map<String, dynamic> json) {
	if (json['curPage'] != null) {
		data.curPage = json['curPage']?.toInt();
	}
	if (json['datas'] != null) {
		data.datas = new List<TreeInfoItemDataData>();
		(json['datas'] as List).forEach((v) {
			data.datas.add(new TreeInfoItemDataData().fromJson(v));
		});
	}
	if (json['offset'] != null) {
...
Map<String, dynamic> treeInfoItemDataToJson(TreeInfoItemData entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
...
treeInfoItemDataDataFromJson(TreeInfoItemDataData data, Map<String, dynamic> json) {
...
Map<String, dynamic> treeInfoItemDataDataToJson(TreeInfoItemDataData entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
