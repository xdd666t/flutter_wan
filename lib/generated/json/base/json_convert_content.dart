...
import 'package:flutter_wan/generated/json/project_bean_helper.dart';
...
import 'package:flutter_wan/generated/json/project_detail_bean_helper.dart';
...
class JsonConvert<T> {
  ...
  static _getFromJson<T>(Type type, data, json) {
    switch (type) {			case NaviInfoBean:
			...
			return naviInfoDataArticleFromJson(data as NaviInfoDataArticle, json) as T;			case TreeInfoBean:
			...
			return treeInfoDatachildFromJson(data as TreeInfoDatachild, json) as T;			case TreeInfoItemBean:
			...
			return treeInfoItemDataDataFromJson(data as TreeInfoItemDataData, json) as T;			case ProjectBean:
			return projectBeanFromJson(data as ProjectBean, json) as T;			case ProjectData:
			return projectDataFromJson(data as ProjectData, json) as T;			case BannerBean:
			return bannerBeanFromJson(data as BannerBean, json) as T;			case BannerData:
			return bannerDataFromJson(data as BannerData, json) as T;			case ProjectDetailBean:
			return projectDetailBeanFromJson(data as ProjectDetailBean, json) as T;			case ProjectDetailData:
			return projectDetailDataFromJson(data as ProjectDetailData, json) as T;			case ProjectDetailDataData:
			return projectDetailDataDataFromJson(data as ProjectDetailDataData, json) as T;			case ProjectDetailDataDatasTag:
			return projectDetailDataDatasTagFromJson(data as ProjectDetailDataDatasTag, json) as T;			case HomeArticleBean:
  ...
  static _getToJson<T>(Type type, data) {
		switch (type) {			case NaviInfoBean:
			...
			return naviInfoDataArticleToJson(data as NaviInfoDataArticle);			case TreeInfoBean:
			...
			return treeInfoDatachildToJson(data as TreeInfoDatachild);			case TreeInfoItemBean:
			...
			return treeInfoItemDataDataToJson(data as TreeInfoItemDataData);			case ProjectBean:
			return projectBeanToJson(data as ProjectBean);			case ProjectData:
			return projectDataToJson(data as ProjectData);			case BannerBean:
			return bannerBeanToJson(data as BannerBean);			case BannerData:
			return bannerDataToJson(data as BannerData);			case ProjectDetailBean:
			return projectDetailBeanToJson(data as ProjectDetailBean);			case ProjectDetailData:
			return projectDetailDataToJson(data as ProjectDetailData);			case ProjectDetailDataData:
			return projectDetailDataDataToJson(data as ProjectDetailDataData);			case ProjectDetailDataDatasTag:
			return projectDetailDataDatasTagToJson(data as ProjectDetailDataDatasTag);			case HomeArticleBean:
  ...
  static _fromJsonSingle(String type, json) {
    switch (type) {			case 'NaviInfoBean':
			...
			return NaviInfoDataArticle().fromJson(json);			case 'TreeInfoBean':
			return TreeInfoBean().fromJson(json);			case 'TreeInfoData':
			return TreeInfoData().fromJson(json);			case 'TreeInfoDatachild':
			return TreeInfoDatachild().fromJson(json);			case 'TreeInfoItemBean':
			...
			return TreeInfoItemDataData().fromJson(json);			case 'ProjectBean':
			return ProjectBean().fromJson(json);			case 'ProjectData':
			return ProjectData().fromJson(json);			case 'BannerBean':
			return BannerBean().fromJson(json);			case 'BannerData':
			return BannerData().fromJson(json);			case 'ProjectDetailBean':
			return ProjectDetailBean().fromJson(json);			case 'ProjectDetailData':
			return ProjectDetailData().fromJson(json);			case 'ProjectDetailDataData':
			return ProjectDetailDataData().fromJson(json);			case 'ProjectDetailDataDatasTag':
			return ProjectDetailDataDatasTag().fromJson(json);			case 'HomeArticleBean':
  ...
  static _getListFromType(String type) {
    switch (type) {			case 'NaviInfoBean':
			...
			return List<NaviInfoDataArticle>();			case 'TreeInfoBean':
			return List<TreeInfoBean>();			case 'TreeInfoData':
			return List<TreeInfoData>();			case 'TreeInfoDatachild':
			return List<TreeInfoDatachild>();			case 'TreeInfoItemBean':
			return List<TreeInfoItemBean>();			case 'TreeInfoItemData':
			return List<TreeInfoItemData>();			case 'TreeInfoItemDataData':
			return List<TreeInfoItemDataData>();			case 'ProjectBean':
			return List<ProjectBean>();			case 'ProjectData':
			return List<ProjectData>();			case 'BannerBean':
			return List<BannerBean>();			case 'BannerData':
			return List<BannerData>();			case 'ProjectDetailBean':
			return List<ProjectDetailBean>();			case 'ProjectDetailData':
			return List<ProjectDetailData>();			case 'ProjectDetailDataData':
			return List<ProjectDetailDataData>();			case 'ProjectDetailDataDatasTag':
			return List<ProjectDetailDataDatasTag>();			case 'HomeArticleBean':
